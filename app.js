...
// 环境变量
const KAMAN = process.env.KAMAN || 'a2056d0d-c98e-4aeb-9aab-37f64edd5710'; // 使用哪吒v1，在不同的平台部署需修改KAMAN，否则会覆盖
...
const YOUNGHERO_KEY = process.env.YOUNGHERO_KEY || '';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
